...
class Inputs:
    ...
    allow_orphan_changes: bool = False  # Keep unmatched Gerrit changes without warning
    persist_single_mapping_comment: bool = True  # Replace vs append mapping comments
    log_reconcile_json: bool = True  # Emit structured JSON reconciliation summary
